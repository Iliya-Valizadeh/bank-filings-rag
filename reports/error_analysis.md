...
| 8 | Reportable segments | 23 | 239, 8, 24, 46, 240 | **Answer key too narrow, and its answer is out of date.** p. 24 describes the segments and the Q4 2024 split of Personal & Commercial Banking into two segments. p. 240 is the segment note. Both answer the question, but the key lists only p. 23. The key's answer text still says "Personal & Commercial Banking" (see below). |
...
- **Five of nine misses have the answer past word piece 256** on the answer-key page
...
- **Four of nine retrieved a page that does contain the answer** (Q1, 5, 7, 22). The
...
- **Two retrieved a neighbouring page of the right section** (Q19, 25). Returning page
  ranges instead of single pages, or indexing overlapping two-page windows, would
  probably fix both.
- **Two are term collisions** (Q12, 22): a word that means one thing in the question
  and appears everywhere in another sense.
...
## A problem with the answer key itself

Q8's answer text lists "Personal & Commercial Banking" as one segment. The report says
(p. 23 footnote 5 and p. 24) that from Q4 2024 it became two segments: Personal Banking
and Commercial Banking. The page number is right, but the answer text needs updating.
Q7's "98,000+ employees" (p. 4) is a headcount. The highlights table on p. 23 gives
94,838 full-time equivalents. Both are correct; the answer could say which one it means.
I have not edited either. Both questions are in the hand-checked set, so they're yours
to change.
